  ...
  constructor(root) {
    ...
    root.innerHTML = `
      ...
      <div class="hud__panel hud__help" data-help>
        ...
        <div><kbd>Shift</kbd> hold sprint · <kbd>Shift</kbd>+<kbd>Ctrl</kbd> slide · <kbd>Ctrl</kbd>+dir roll</div>
        <div><kbd>RMB</kbd> focus · ON body+cam · OFF A/D turn · <kbd>Space</kbd> jump</div>
