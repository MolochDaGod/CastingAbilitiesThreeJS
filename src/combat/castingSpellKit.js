...
const CASTING_SPELL_CORE = [
  ...
  },
  {
    ...
    label: 'Holy Light',
    description: 'Holy cast tell + moon beam — Holy Staff light line.',
    element: 'holy',
    pathMode: 'stream',
    style: 'spell',
    animRole: 'cast',
    ...
    abilityClass: 'WindAbility',
    castEffectId: H.cast,
    travelEffectId: H.travel,
    impactEffectId: H.impact,
    staffWeaponId: H.staffWeaponId,
    rangeM: 14,
    cooldown: 1.3,
    castDuration: 0.9,
    staminaCost: 12,
    slot: 8,
    slotType: 'primary',
    learnFrom: 'holy phase VFX · moon_beam (sandbox B)',
    assets: [
      'src/combat/elementWeaponSkills.js#holy',
